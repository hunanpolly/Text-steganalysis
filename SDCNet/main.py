...
parser = argparse.ArgumentParser(description='BI_SDC')
...
parser.add_argument('-kernel-sizes', type=str, default=[1,3,5,7], \
...
parser.add_argument('-idx-gpu', type=str, default='1',\
...
# model
model = ATTBI_SDC.BI_SDC(args, text_field)
